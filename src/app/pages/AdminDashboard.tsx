...
import { LogOut, Plus, Clock, AlertCircle, Users, Calendar as CalendarIcon, List, BarChart3 } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const [selectedTaskForAssign, setSelectedTaskForAssign] = useState<{ id: string; title: string } | null>(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Main Tabs */}
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'tasks' | 'reports')} className="space-y-6">
          <TabsList>
                ...
                {tasks.length === 0 ? (
                  <Card className="col-span-full">
                    <CardContent className="py-12 text-center">
                      <p className="text-gray-500 mb-4">No hay tareas creadas</p>
                      <Button onClick={() => setIsCreateDialogOpen(true)}>
                        <Plus className="w-4 h-4 mr-2" />
                        Crear primera tarea
                      </Button>
